...
σ_elastic = σ_axial + σ_bending,z + σ_bending,y

塑性修正后的正应力：

σ = σ_axial + σ_bending,z / k_z + σ_bending,y / k_y
...
σ_elastic = 8.000 + 75.000 + 20.000 = 103.000 MPa

σ = 8.000 + 75.000/1.12 + 20.000/1.05
  = 8.000 + 66.964 + 19.048
  = 94.012 MPa
...
σ_eq,elastic = sqrt(103.000^2 + 3*90.000^2)
            = sqrt(10609 + 24300)
            = sqrt(34909)
            = 186.839 MPa

σ_eq = sqrt(94.012^2 + 3*75.000^2)
     = sqrt(8838.256 + 16875)
     = sqrt(25713.256)
     = 160.353 MPa
...
MS_elastic = 230 / 186.839 - 1 = 0.2310

MS = 230 / 160.353 - 1 = 0.4344

结论：该工况下 `MS > 0`，满足强度要求；并且塑性修正后裕度由 `0.2310` 提升至 `0.4344`。
