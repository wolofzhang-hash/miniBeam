...
TRANSLATIONS: dict[str, dict[str, str]] = {
    LANG_ZH: {
        ...
        "action.export_report": "导出报告(HTML)",
        "action.export_bundle": "导出结果包(ZIP)",
        "action.help": "手册",
        "action.copyright": "关于",
        "action.undo": "撤销",
        "action.redo": "重做",
        ...
        "status.ready": "就绪：请选择一个操作。",
        "status.action": "操作：{action}",
    ...
    LANG_EN: {
        ...
        "action.export_report": "Export Report (HTML)",
        "action.export_bundle": "Export Bundle (ZIP)",
        "action.help": "Manual",
        "action.copyright": "About",
        "action.undo": "Undo",
        "action.redo": "Redo",
        ...
        "status.ready": "Ready: choose an operation.",
