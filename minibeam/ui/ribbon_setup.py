        ...
        tabs=[
            RibbonTab(t("tab.home"), groups=[
                RibbonGroup(t("group.file"), items=[
                    RibbonItem("act_new", kind="action", size="S"),
                    RibbonItem("act_open", kind="action", size="S"),
                    RibbonItem("act_save", kind="action", size="S"),
                ]),
                ...
                RibbonGroup(t("group.language"), items=[
                    RibbonItem("language_switch", kind="widget", size="S"),
                ]),
            ]),
            RibbonTab(t("tab.model"), groups=[
                RibbonGroup(t("group.geometry"), items=[
                    RibbonItem("act_select", kind="action", size="S"),
                    RibbonItem("act_add_point", kind="action", size="S"),
                ]),
                RibbonGroup(t("group.properties"), items=[
                    RibbonItem("act_materials", kind="action", size="S"),
                    RibbonItem("act_sections", kind="action", size="S"),
                    RibbonItem("act_assign_prop", kind="action", size="S"),
                ]),
            ]),
            RibbonTab(t("tab.boundary"), groups=[
                RibbonGroup(t("group.constraints"), items=[
                    RibbonItem("act_add_dx", kind="action", size="S", text_override="Add D"),
                    RibbonItem("act_add_bush", kind="action", size="S"),
                ]),
                RibbonGroup(t("group.loads"), items=[
                    RibbonItem("act_add_fy", kind="action", size="S", text_override="Add F"),
                    RibbonItem("act_add_udl", kind="action", size="S"),
                ]),
            ]),
            RibbonTab(t("tab.analysis"), groups=[
                RibbonGroup(t("group.solve"), items=[
                    RibbonItem("act_validate", kind="action", size="S"),
                    RibbonItem("act_solve", kind="action", size="S"),
                ]),
                RibbonGroup(t("group.results"), items=[
                    RibbonItem("act_show_results", kind="action", size="S"),
                    RibbonItem("act_export_csv", kind="action", size="S"),
                    RibbonItem("act_export_report", kind="action", size="S"),
                    RibbonItem("act_export_bundle", kind="action", size="S"),
                ]),
            ]),
            RibbonTab(t("tab.view"), groups=[
                RibbonGroup(t("group.navigation"), items=[
                    RibbonItem("act_fit_all", kind="action", size="S"),
                    RibbonItem("act_reset_view", kind="action", size="S"),
                ]),
            ]),
            RibbonTab(t("tab.background"), groups=[
                RibbonGroup(t("group.image"), items=[
                    RibbonItem("act_bg_import", kind="action", size="S"),
            ...
            RibbonTab(t("tab.help"), groups=[
                RibbonGroup(t("group.support"), items=[
                    RibbonItem("act_help_pdf", kind="action", size="S"),
