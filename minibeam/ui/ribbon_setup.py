        ...
        tabs=[
            RibbonTab(t("tab.home"), groups=[
                RibbonGroup(t("group.file"), items=[
                    RibbonItem("act_new", kind="action"),
                    RibbonItem("act_open", kind="action"),
                    RibbonItem("act_save", kind="action"),
                ]),
                RibbonGroup(t("group.edit"), items=[
                    RibbonItem("act_undo", kind="action"),
                    RibbonItem("act_redo", kind="action"),
                    RibbonItem("act_delete", kind="action"),
                ]),
                RibbonGroup(t("group.language"), items=[
                    RibbonItem("language_switch", kind="widget"),
                ]),
            ]),
            RibbonTab(t("tab.model"), groups=[
                RibbonGroup(t("group.geometry"), items=[
                    RibbonItem("act_select", kind="action"),
                    RibbonItem("act_add_point", kind="action"),
                ]),
                RibbonGroup(t("group.properties"), items=[
                    RibbonItem("act_materials", kind="action"),
                    RibbonItem("act_sections", kind="action"),
                    RibbonItem("act_assign_prop", kind="action"),
                ]),
            ]),
            RibbonTab(t("tab.boundary"), groups=[
                RibbonGroup(t("group.constraints"), items=[
                    RibbonItem("act_add_dx", kind="action", text_override="Add D"),
                    RibbonItem("act_add_bush", kind="action"),
                ]),
                RibbonGroup(t("group.loads"), items=[
                    RibbonItem("act_add_fy", kind="action", text_override="Add F"),
                    RibbonItem("act_add_udl", kind="action"),
                ]),
            ]),
            RibbonTab(t("tab.analysis"), groups=[
                RibbonGroup(t("group.solve"), items=[
                    RibbonItem("act_validate", kind="action"),
                    RibbonItem("act_solve", kind="action"),
                ]),
                RibbonGroup(t("group.results"), items=[
                    RibbonItem("act_show_results", kind="action"),
                    RibbonItem("act_export_csv", kind="action"),
                    RibbonItem("act_export_report", kind="action"),
                    RibbonItem("act_export_bundle", kind="action"),
                ]),
            ]),
            RibbonTab(t("tab.view"), groups=[
                RibbonGroup(t("group.navigation"), items=[
                    RibbonItem("act_fit_all", kind="action"),
                    RibbonItem("act_reset_view", kind="action"),
                ]),
            ]),
            RibbonTab(t("tab.background"), groups=[
                RibbonGroup(t("group.image"), items=[
                    RibbonItem("act_bg_import", kind="action"),
                    RibbonItem("act_bg_calibrate", kind="action"),
                    RibbonItem("act_bg_opacity", kind="action"),
                    RibbonItem("act_bg_bw", kind="toggle"),
                    RibbonItem("act_bg_visible", kind="toggle"),
                    RibbonItem("act_bg_clear", kind="action"),
                ]),
            ]),
            RibbonTab(t("tab.help"), groups=[
                RibbonGroup(t("group.support"), items=[
                    RibbonItem("act_help_pdf", kind="action"),
                    RibbonItem("act_about", kind="action"),
                ]),
            ]),
        ]
    )
