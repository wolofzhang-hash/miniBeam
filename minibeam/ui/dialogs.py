...
class SectionManagerDialog(QDialog):
    def __init__(self, prj: Project, parent=None):
        ...
        self.lbl_props = QLabel("A= -   Iy= -   Iz= -   J= -   c_t= -")
    ...
    def _update_preview(self):
        ...
        try:
            ...
            self.lbl_props.setText(f"A={props.A:.3f} mm²   Iy={props.Iy:.3f} mm⁴   Iz={props.Iz:.3f} mm⁴   J={props.J:.3f} mm⁴   c_t={props.c_t:.3f} mm")
        except Exception:
            self.lbl_props.setText("A= -   Iy= -   Iz= -   J= -   c_t= -")
    ...
    def add_or_update(self):
        ...
        if uid and uid in self.prj.sections and self.prj.sections[uid].name == name:
            s = self.prj.sections[uid]
            s.type = typ
            s.A, s.Iy, s.Iz, s.J, s.c_z, s.c_t = props.A, props.Iy, props.Iz, props.J, props.c_z, props.c_t
